...
import static definitions.xPathLibrary.*;
...
public class RustamRStepDefs {
    ...
    public void rustamrShouldSeePageTitleAs(String arg0) {
        assertThat(Objects.equals(getDriver().getTitle(), sTitle));
    }


    @Then("RustamR clicks on {string} button")
    public void rustamrClicksOnStringButton(String sButton) {
        getDriver().findElement(By.xpath(sButton)).click();
    }
